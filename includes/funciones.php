...
function ingresar_datos_clienteFinal($nombreEmpresa,$ciudadEmpresa, $nombre, $celular,$cargo,$email,$categoria,$otro_categoria, $pregunta1, $pregunta2,$pregunta3,$pregunta4,$pregunta4_1,$pregunta5,$pregunta6,$pregunta6_1,$pregunta,$pregunta8){             
